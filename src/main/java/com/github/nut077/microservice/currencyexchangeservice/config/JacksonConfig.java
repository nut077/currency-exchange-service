package com.github.nut077.microservice.currencyexchangeservice.config;
...
public class JacksonConfig {
    ...
    public Jackson2ObjectMapperBuilder jacksonBuilder() {
        ...
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("d-MM-yyyy HH:mm:ss");
